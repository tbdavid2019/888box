...
assert(serviceWorker.includes("const CACHE_NAME = '888box-pwa-v2';"), 'The service worker cache version must advance when precached PWA code changes.');
...
assert(registrationModule.includes('安裝 888box'), 'The installation prompt must use a clear Chinese call to action.');
